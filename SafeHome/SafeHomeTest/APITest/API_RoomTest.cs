...
namespace SafeHomeTest.APITest
{
    ...
    public class API_RoomTest
    {
        ...
        [TestMethod]
        public void _API_getRoomByName_Pass()
        {
            rooms.Add(r1);
            rooms.Add(r2);
            rooms.Add(r3);
        ...
        [TestMethod]
        public void _API_getRoomByName_Fail()
        {
            rooms.Add(r1);
            rooms.Add(r2);
            rooms.Add(r3);
        ...
        [TestMethod]
        public void _API_getRoomByID_Pass()
        {
            rooms.Add(r1);
            rooms.Add(r2);
            rooms.Add(r3);
        ...
        [TestMethod]
        public void _API_getRoomByID_Fail()
        {
            rooms.Add(r1);
            rooms.Add(r2);
            rooms.Add(r3);
